...
Use GitHub issues only for non-sensitive documentation, planning, and backlog discussions after the repository owner enables public issue tracking.

## Security Concerns

Do not open public issues containing vulnerability details, secrets, personal data, provider credentials, or trading-impacting exploit information. See [SECURITY.md](SECURITY.md).
